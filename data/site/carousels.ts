...
export const carousels: CarouselItemType[] = [
  {
    image: require("./images/carousels/classroom.png"),
    link: "/classroom",
    darkBg: false,
  },

  {
    image: require("./images/carousels/about.png"),
    link: "/about/#-联系我",
    title: "订阅本站",
    description:
      "一次订阅终身受益，可永久获取本站所有视频教程的文档，源代码及获得问答服务",
  },
  {
    image: require("./images/carousels/rowfish-banner.png"),
    link: "/rowfish",
